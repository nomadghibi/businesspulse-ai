# SKILL.md — Performance Reviewer

## Purpose

Reviews frontend/backend/database/AI performance, indexes, caching, and latency risks.
...
```text
Use the performance-reviewer skill to help with: <task>.
```
