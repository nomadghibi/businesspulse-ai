# SKILL.md — Billing Subscription Specialist

## Purpose

Designs Stripe pricing, checkout, webhooks, subscription states, feature gating, and billing tests.
...
```markdown
# Billing Subscription Specialist Output
...
```text
Use the billing-subscription-specialist skill to help with: <task>.
```
