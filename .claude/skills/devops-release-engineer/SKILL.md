# SKILL.md — Devops Release Engineer

## Purpose

Prepares deployment, CI/CD, environment variables, migrations, smoke tests, and rollback plans.
...
```text
Use the devops-release-engineer skill to help with: <task>.
```
