# SKILL.md — Privacy Compliance Reviewer

## Purpose

Prepares privacy, terms, retention, deletion, AI provider disclosure, and data handling requirements.
...
```text
Use the privacy-compliance-reviewer skill to help with: <task>.
```
