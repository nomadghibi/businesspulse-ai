# SKILL.md — Data Ingestion Specialist

## Purpose

Designs CSV upload, column mapping, validation, normalization, and data quality reporting.
...
```markdown
# Data Ingestion Specialist Output
...
```text
Use the data-ingestion-specialist skill to help with: <task>.
```
