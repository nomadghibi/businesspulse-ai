# SKILL.md — Observability Engineer

## Purpose

Adds logging, monitoring, Sentry-style error tracking, AI run logs, and operational alerts.
...
```text
Use the observability-engineer skill to help with: <task>.
```
