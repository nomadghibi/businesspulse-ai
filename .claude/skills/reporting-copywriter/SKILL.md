# SKILL.md — Reporting Copywriter

## Purpose

Writes clear business-owner-friendly executive summaries, alerts, recommendations, CTAs, and report copy.
...
```text
Use the reporting-copywriter skill to help with: <task>.
```
