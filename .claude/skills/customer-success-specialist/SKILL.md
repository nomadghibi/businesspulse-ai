# SKILL.md — Customer Success Specialist

## Purpose

Designs onboarding, help docs, pilot support, activation milestones, and feedback loops.
...
```markdown
# Customer Success Specialist Output
...
```text
Use the customer-success-specialist skill to help with: <task>.
```
