# SKILL.md — Ai Agent Designer

## Purpose

Designs AI agents, tool permissions, orchestration, guardrails, and audit logging.
...
```text
Use the ai-agent-designer skill to help with: <task>.
```
