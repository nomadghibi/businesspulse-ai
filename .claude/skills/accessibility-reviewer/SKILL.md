# SKILL.md — Accessibility Reviewer

## Purpose

Checks keyboard navigation, semantic HTML, labels, contrast, focus states, and form accessibility.
...
```text
Use the accessibility-reviewer skill to help with: <task>.
```
