# SKILL.md — Launch Planner

## Purpose

Plans beta, pilot, paid launch, demo flow, launch blockers, offers, and success metrics.
...
```text
Use the launch-planner skill to help with: <task>.
```
