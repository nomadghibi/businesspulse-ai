# SKILL.md — Prompt Contracts Specialist

## Purpose

Creates strict AI prompt contracts, JSON output schemas, and fallback behavior.
...
```markdown
# Prompt Contracts Specialist Output
...
```text
Use the prompt-contracts-specialist skill to help with: <task>.
```
