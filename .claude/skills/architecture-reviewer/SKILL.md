# SKILL.md — Architecture Reviewer

## Purpose

Reviews system architecture, data flow, service boundaries, scalability, and MVP simplicity.
...
```text
Use the architecture-reviewer skill to help with: <task>.
```
