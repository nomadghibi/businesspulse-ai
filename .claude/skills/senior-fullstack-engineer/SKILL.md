# SKILL.md — Senior Fullstack Engineer

## Purpose

Builds frontend, backend, API routes, forms, dashboards, reports, and app logic.
...
```markdown
# Senior Fullstack Engineer Output
...
```text
Use the senior-fullstack-engineer skill to help with: <task>.
```
