# SKILL.md — Database Architect

## Purpose

Designs Postgres/Supabase schema, RLS, indexes, migrations, and tenant isolation.
...
```text
Use the database-architect skill to help with: <task>.
```
