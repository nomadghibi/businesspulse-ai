# SKILL.md — Analytics Engineer

## Purpose

Creates reliable metric layers, aggregation tables, metric snapshots, and reporting models.
...
```text
Use the analytics-engineer skill to help with: <task>.
```
