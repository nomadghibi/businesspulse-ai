# SKILL.md — Ai Safety Reviewer

## Purpose

Reviews AI for hallucination, prompt injection, unsafe actions, unsupported claims, and data leakage.
...
```text
Use the ai-safety-reviewer skill to help with: <task>.
```
