# SKILL.md — Security Reviewer

## Purpose

Audits auth, RBAC, tenant isolation, file uploads, APIs, secrets, SQL, and integrations.
...
```text
Use the security-reviewer skill to help with: <task>.
```
