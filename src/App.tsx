...
import { SettingsOpsPanel } from "./components/SettingsOpsPanel";
        ...
        <div className="shortcuts-modal" onClick={() => setShowShortcuts(false)}>
          <section className="shortcuts-panel" onClick={(event) => event.stopPropagation()}>
            ...
            <ul className="bullets">
              ...
              <li><code>Shift</code>+<code>E</code>: Open Settings</li>
  ...
  return (
    <div className="stack">
      ...
      <SettingsOpsPanel
        ...
        opsHealthSummary={opsHealth.summary}
        onRefresh={refreshOpsMetrics}
      />
    </div>
  );
}
